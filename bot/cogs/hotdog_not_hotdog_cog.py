...
class HotDogCog(commands.Cog):
    def __init__(self, bot):
        ...
        model_path = os.path.join(data_path, 'hotdog_not_hotdog_model.h5')
        logger.info(f'data_path:{data_path}, base_dir: {base_dir}, model_path: {model_path}')
    ...
    async def hotdog(self, interaction: discord.Interaction, attachment: discord.Attachment):
        ...
        await interaction.followup.send(result, attachment=attachment, ephemeral=False)
