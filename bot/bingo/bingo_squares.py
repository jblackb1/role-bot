bingo_squares = [
    ...
    "Death effect save DC 20+ success",
    "Fear effect save crit success, immune 24h",
    "Disease/poison save crit success",
    "Called shot crit hit confirmed",
    "Hero point reroll success/fail",
    "Crafting successful magic item",
    "Misfire on spell attack roll",
    ...
    "Someone rolls max damage on an attack",
    ...
    "An NPC is revealed to be a disguised enemy",
